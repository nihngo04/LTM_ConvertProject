...
import Utils.FileConversionUtils;
...
public class FileConverter_DAO {
	...
	public static void addTask(Task task) {
		...
		try {
			PreparedStatement statement = database.prepareStatement(query, task.getUserId(), task.getInputFilePath(),
					task.getOutputFilePath(), task.getStatus());
	...
	public static void updateTask(Task task) {
		...
		try {
			PreparedStatement statement = database.prepareStatement(query, task.getOutputFilePath(), task.getStatus(),
					task.getId());
